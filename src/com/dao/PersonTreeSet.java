...
public class PersonTreeSet implements Comparable<Object> {
     ...
     * public int compare(Student s1, Student s2) { // 比较年龄 int ageCompareResult
     * = s1.getAge() - s2.getAge(); // 比较姓名 int nameCompare =
     * s1.getName().compareTo(s2.getName()); // 年龄相同比较姓名，年龄不同按照年龄排序 int
     * nameCompareResult = ageCompareResult == 0 ? nameCompare :
     * ageCompareResult; return nameCompareResult; } });
     */
}
