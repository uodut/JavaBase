package com.nubia.util.concurrent;
/**
 * //LinkedDeque,,ConcurrentSkipListSet,ConcurrentHashMap
 * 
 * @date 2016年3月1日
 * @author <a href = "wang.gaoliang@zte.com.cn">王高亮</a> 原理
 ...
 *         但是，仅仅是将数组声明为final的并不保证数组成员也是final的，这需要实现上的保证。 用法和HashMap是一样的
 *         ConcurrentHashMap实现技术是保证HashEntry几乎是不可变的。HashEntry代表每个hash链中的一个节点
 *         ----
 *         ------------------------------------------------------------------
 *         -------------------------------------------------------------------
 *         ConcurrentSkipListMap：提供排序功能 能
 */
